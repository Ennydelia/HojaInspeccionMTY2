							  ...
							  while (odbc_fetch_row($resultado)) {
									if(odbc_result($resultado, 1) <> "0"){
										...
										while (odbc_fetch_row($resultado)) {
											...
											echo '<tr><td>'.odbc_result($resultado, 1).'</td><td><input style="width:100px;" autocomplete="off" autofocus="on" lang="es" type="text" id="'.odbc_result($resultado, 1).'" name="'.odbc_result($resultado, 1).'" value="'.odbc_result($resultado, 13).'"></td><td></td><td></td></tr>';
											$count++;
										}
