...
<div class="container-fluid">     
    ...
    <div class= "col-lg-12 col-md-12 col-sm-12">
      <?php
        ...
        //--REVISION DE AGREGADO DE DATOS---
          $consulta3 = "SELECT TOP(1)BOM_NO_RECH, TENSION_P_INI_1 FROM [MTY_PROD_SSM].[dbo].[SSM_INSPECCION_TEN_RECHAZO] WHERE BOM_NO_RECH ='" .strtoupper(($_GET["bom"])). "' AND TENSION_P_INI_1 IS NULL";
  ...
  //------------------------ REVISA QUE NO HALLA DATOS EN LAS TENSIONES 2
        If($yavalidado == 0){
        //--REVISION DE AGREGADO DE DATOS---
          $consulta3 = "SELECT TOP(1)BOM_NO_RECH, TENSION_P_INI_2 FROM [MTY_PROD_SSM].[dbo].[SSM_INSPECCION_TEN_RECHAZO] WHERE BOM_NO_RECH ='" .strtoupper(($_GET["bom"])). "' AND TENSION_P_INI_2 IS NULL";
          $resultado3 = odbc_do($conn, $consulta3);
          $yavalidado = 2;
          while(odbc_fetch_row($resultado3)){
            $yavalidado = 1;
...
//-----------------------------REVISA QUE NO EXISTAN DATOS EN LAS TENSIONES 3           
          If($yavalidado == 2){
            $consulta3 = "SELECT TOP(1)BOM_NO_RECH, TENSION_P_INI_3 FROM [MTY_PROD_SSM].[dbo].[SSM_INSPECCION_TEN_RECHAZO] WHERE BOM_NO_RECH ='" .strtoupper(($_GET["bom"])). "' AND TENSION_P_INI_3 IS NULL";
            $resultado3 = odbc_do($conn, $consulta3);
            $yavalidado = 3;
            while(odbc_fetch_row($resultado3)){
              $yavalidado = 1;
...
//-----------------------------REVISA QUE NO EXISTAN DATOS EN LAS TENSIONES 4            
                If($yavalidado == 3){
                  $consulta3 = "SELECT TOP(1)BOM_NO_RECH, TENSION_P_INI_4 FROM [MTY_PROD_SSM].[dbo].[SSM_INSPECCION_TEN_RECHAZO] WHERE BOM_NO_RECH ='" .strtoupper(($_GET["bom"])). "' AND TENSION_P_INI_4 IS NULL";
                  $resultado3 = odbc_do($conn, $consulta3);
                  $yavalidado = 4;
                  while(odbc_fetch_row($resultado3)){
                    $yavalidado = 1;                    
