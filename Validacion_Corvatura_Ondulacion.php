			...
			<div class="container-fluid">
				 ...
				 <div class="row">
					...
					if(isset($_GET['bom']))
					{
								...
								echo "<center><label><h4>Corvatura de Ondulación</h4></label></center>";
							...
							//SE EL ACOMODO DE DATOS 
								echo '<form id="datosform" method="post" action="insert_Corvatura.php">
								</div>
								</div>
								 <div class="row">
									<div class= "col-lg-12 col-md-12 col-sm-12">
										...
										$.ajax({
												...
												success: function(data) {
															...
															if(res[0]=="Error"){
																...
																window.location.replace("Validacion_tensiones.php?wo=<?php echo $_GET["wo"]."&bom=".$_GET["bom"];?>");
															}
															else{
