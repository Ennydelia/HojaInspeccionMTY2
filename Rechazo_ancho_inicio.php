		...
		<div class= "col-lg-12 col-md-12 col-sm-12">
			<?php
				...
				while (odbc_fetch_row($resultado)) {
					...
					echo '<tr><td></td><td><input type="hidden" name="campo" value="VAL_INI_ANCHO"><input name="siguiente" id="siguiente" type="submit" class="btn btn-primary" value="Siguiente"></td></tr></table></form>';
				}
			?>
		</div>
	</div>
