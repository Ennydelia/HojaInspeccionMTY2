    ...
    <div class="row">
      <div class= "col-lg-12 col-md-12 col-sm-12">
        <?php
          ...
          if(isset($_GET['bom']))
          {
            echo "<center><label><h3>Inspeccion de Ondulacion de Rollos Madre</h3></label></center>";
            ...
            while (odbc_fetch_row($resultado)) {
              if(odbc_result($resultado, 1) <> "0"){
                ...
                echo '<form id="datosform" method="post" action="insert_rondulaciones.php">
                  <div class="row">
                    <div class= "col-lg-12 col-md-12 col-sm-12">
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if(res[0]=="Error"){
              ...
              window.location.replace("Rechazo_Peso_rollo.php?wo=<?php echo $_GET["wo"]."&bom=".$_GET["bom"];?>");
            }
            else{
