			...
			<?php
				...
				while (odbc_fetch_row($resultado)) {
					...
					$count = 1;
						...
						echo '<tr><td></td><td><input type="hidden" name="campo" value="VAL_CAMBER_INICIO"><input name="siguiente" id="siguiente" type="submit" class="btn btn-primary" value="Siguiente">&ensp;<input name="continuar" id="continuar" style="display:none;" type="button" value="Mandar a Rechazo" class="btn btn-danger"onclick="PagRec()"></td></tr></table></form>';
					}
			?>
		</div>
	</div>
